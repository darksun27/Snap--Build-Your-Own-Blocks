...
// AgentSpeechBubbleMorph: referenced constructors

var AgentSpeechBubbleMorph;

// AgentSpeechBubbleMorph inherits from BoxMorph:

AgentSpeechBubbleMorph.prototype = new BoxMorph();
AgentSpeechBubbleMorph.prototype.constructor = AgentSpeechBubbleMorph;
AgentSpeechBubbleMorph.uber = BoxMorph.prototype;

// AgentSpeechBubbleMorph instance creation:

function AgentSpeechBubbleMorph(
    contents,
    color,
    pointRight,
    edge,
...
AgentSpeechBubbleMorph.prototype.init = function (
    ...
    this.isThought = isThought || false; // draw "think" bubble
    this.isClickable = false;
    AgentSpeechBubbleMorph.uber.init.call(
        this,
        edge || 6,
        border || ((border === 0) ? 0 : 1),
        borderColor || new Color(140, 140, 140)
...
AgentSpeechBubbleMorph.prototype.drawNew = function () {
    // re-build my contents
    if (this.contentsMorph) {
        this.contentsMorph.destroy();
    }
    ...
    // draw my outline
    AgentSpeechBubbleMorph.uber.drawNew.call(this);
...
AgentSpeechBubbleMorph.prototype.outlinePath = function (
    context,
    radius,
    inset
) {
...
AgentSpeechBubbleMorph.prototype.shadowImage = function (off, color) {
    // fallback for Windows Chrome-Shadow bug
    var fb, img, outline, sha, ctx,
        offset = off || new Point(7, 7),
        clr = color || new Color(0, 0, 0);
...
AgentSpeechBubbleMorph.prototype.shadowImageBlurred = function (off, color) {
    var fb, img, sha, ctx,
        offset = off || new Point(7, 7),
        blur = this.shadowBlur,
        clr = color || new Color(0, 0, 0);
...
// AgentSpeechBubbleMorph resizing

AgentSpeechBubbleMorph.prototype.fixLayout = function () {
    this.removeShadow();
    this.drawNew();
    this.addShadow(new Point(2, 2), 80);
};
